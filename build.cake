...
Setup(context =>
{
    ...
    Information($"Building Odyssey with configuration {configuration}");
});
...
Task("Build")
    .Does(() => 
    {
        DotNetBuild("odyssey.sln", new DotNetBuildSettings 
        {
